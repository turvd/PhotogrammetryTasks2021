...
{
    cv::Vec3d epipole = F * cv::Vec3d(pt0[0], pt0[1], 1.0);
    double norm = sqrt(epipole[0] * epipole[0] + epipole[1] * epipole[1]);
    return fabs(epipole.dot(cv::Vec3d(pt1[0], pt1[1], 1.0)) / norm) < t;
}
